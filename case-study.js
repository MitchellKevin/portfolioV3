...
const CASE_STUDIES = {
  ...
  /* ===================================================================
     VISDEURBEL — Vangstdata scrollytelling
     =================================================================== */
  "visdeurbel": {
    liveUrl: "https://vis-b05f.onrender.com",
    liveLabel: { en: "View live site ↗", nl: "Bekijk live site ↗" },
    eyebrow: { en: "Case study · Data visualization", nl: "Case study · Datavisualisatie" },
    title: "Visdeurbel",
    tagline: {
      en: "A scrolling data visualization about the Visdeurbel — the camera at Utrecht's Weerdsluis that rings whenever a fish swims past and visitors worldwide press the digital bell. Over four weeks it grew from a raw HTML/JS prototype into a polished, accessible React scrollytelling, fed by a Python pipeline that crunches a 288 MB event log down to ~40 KB.",
      nl: "Een scrollende datavisualisatie over de Visdeurbel — de camera bij de Weerdsluis in Utrecht die afgaat zodra een vis voorbijzwemt en bezoekers wereldwijd op de digitale bel drukken. In vier weken groeide het van een ruw HTML/JS-prototype naar een verzorgde, toegankelijke React-scrollytelling, gevoed door een Python-pijplijn die een eventlog van 288 MB terugbrengt tot ~40 KB.",
    },
    heroImage: "project-images/visdeurbel.png",
    heroAlt: { en: "The Visdeurbel data visualization", nl: "De Visdeurbel-datavisualisatie" },
    tags: ["React + Vite", "D3.js v7", "Canvas API", "GSAP", "Embla Carousel", "Python 3", "IntersectionObserver", "NDJSON"],
    meta: [
      { label: { en: "Role", nl: "Rol" }, value: { en: "Data visualization & front-end", nl: "Datavisualisatie & front-end" } },
      { label: { en: "Timeline", nl: "Tijdlijn" }, value: { en: "4 weeks · 2026", nl: "4 weken · 2026" } },
      { label: { en: "Context", nl: "Context" }, value: { en: "CMD minor — team SPA", nl: "CMD-minor — team-SPA" } },
      { label: { en: "Data", nl: "Data" }, value: { en: "288 MB events → ~40 KB JSON", nl: "288 MB events → ~40 KB JSON" } },
    ],
    sections: [
      { type: "prose",
        heading: { en: "Overview", nl: "Overzicht" },
        lead: { en: "The Visdeurbel (\"fish doorbell\") is a livestream of a lock in Utrecht: when a fish waits to pass, viewers worldwide press a button to alert the lock keeper. This is my data-visualization section of a team SPA — a scrolling story about who rings the bell, when, from where, and with what.",
                nl: "De Visdeurbel is een livestream van een sluis in Utrecht: als een vis wil passeren, drukken kijkers wereldwijd op een knop om de sluiswachter te waarschuwen. Dit is mijn datavisualisatie-sectie binnen een team-SPA — een scrollend verhaal over wie er belt, wanneer, waarvandaan en waarmee." },
        paragraphs: [
          { en: "It grew in four weekly steps: a bare-bones HTML/CSS/JS prototype to find the shapes and the data flow; a rebuild in React + Vite with a real Python data pipeline; a pass on visual polish and accessibility; and a final refactor that gave every chapter its own chart, a synthesized Year mode and a guide fish that swims along as you scroll.",
            nl: "Het groeide in vier wekelijkse stappen: een kaal HTML/CSS/JS-prototype om de vormen en de datastroom uit te vinden; een herbouw in React + Vite met een echte Python-datapijplijn; een ronde visuele afwerking en toegankelijkheid; en een laatste refactor waarin elk hoofdstuk zijn eigen grafiek kreeg, een verzonnen Jaar-modus en een gids-visje dat met je meezwemt terwijl je scrollt." },
          { en: "The technical thread stayed the same throughout: <strong>let the data drive the work</strong>. A Python step does the heavy aggregation up front, the chapters only read the numbers, and every chapter adapts to the period (week / month / year) just by reading the length of the data arrays.",
            nl: "De technische rode draad bleef steeds dezelfde: <strong>laat de data het werk sturen</strong>. Een Python-stap doet vooraf het zware aggregeren, de hoofdstukken lezen alleen de getallen, en elk hoofdstuk past zich aan de periode (week / maand / jaar) aan door simpelweg de lengte van de data-arrays te lezen." },
        ],
      },
      { type: "cards",
        heading: { en: "The story, chapter by chapter", nl: "Het verhaal, hoofdstuk voor hoofdstuk" },
        lead: { en: "Thirteen scroll-triggered chapters, each showing a different side of the data.",
                nl: "Dertien scroll-getriggerde hoofdstukken, elk met een andere kant van de data." },
        cards: [
          { title: { en: "Ring calendar", nl: "Ringkalender" }, desc: { en: "A polar heatmap where every dot is one hour around the month's total — brightness is how often the bell rang.", nl: "Een polaire heatmap waarin elke stip één uur is rond het maandtotaal — helderheid is hoe vaak de bel ging." } },
          { title: { en: "24-hour tide", nl: "24-uurs getij" }, desc: { en: "A round dial whose \"water level\" rises and falls — high tide around 6pm, calmest at 3am.", nl: "Een ronde wijzerplaat waarvan het \"waterpeil\" stijgt en daalt — hoogtij rond 18u, het stilst rond 03u." } },
          { title: { en: "World map & globe", nl: "Wereldkaart & globe" }, desc: { en: "Every country lights up with arcs flowing to Utrecht; an orthographic globe lights each country as evening reaches it.", nl: "Elk land licht op en bogen stromen naar Utrecht; een orthografische globe licht elk land op zodra het daar avond wordt." } },
          { title: { en: "The funnel", nl: "Belstroom" }, desc: { en: "Two ribbons show ~19% actually ring the bell while ~81% click away.", nl: "Twee linten tonen dat ~19% écht aanbelt en ~81% wegklikt." } },
          { title: { en: "Radar", nl: "Radar" }, desc: { en: "Each fish species is a sonar \"ping\"; a time-scrubber sweeps day / week / month.", nl: "Elke vissoort is een sonar-\"ping\"; een tijd-slider veegt door dag / week / maand." } },
          { title: { en: "The net", nl: "Het net" }, desc: { en: "A bubble-pack with the real fish photo in each bubble — toggle count, biomass or weight per fish.", nl: "Een bubble-pack met de echte vis-foto in elke bel — wissel tussen aantal, biomassa of gewicht per vis." } },
          { title: { en: "Chorus of languages", nl: "Koor van talen" }, desc: { en: "The word \"fish\" in each visitor's real language, sized by how many people speak it.", nl: "Het woord \"vis\" in de echte taal van elke bezoeker, zo groot als het aantal sprekers." } },
          { title: { en: "The aquarium", nl: "Het kijkglas" }, desc: { en: "A canvas aquarium where ~80 fish swim, proportional per species, with filter chips and a click-to-startle effect.", nl: "Een canvas-aquarium waarin ~80 vissen zwemmen, proportioneel per soort, met filter-chips en een klik-om-te-schrikken-effect." } },
        ],
      },
      { type: "tech",
        heading: { en: "Tech stack", nl: "Tech stack" },
        items: [
          { name: "React + Vite", desc: { en: "Components, routing and dev-server (from week 2 on).", nl: "Componenten, routing en dev-server (vanaf week 2)." } },
          { name: "D3.js v7", desc: { en: "SVG visualizations — ring, radar, net, languages, map.", nl: "SVG-visualisaties — ring, radar, net, talen, kaart." } },
          { name: "Canvas API", desc: { en: "The aquarium animation (swimming fish) and the pond.", nl: "De aquarium-animatie (zwemmende vissen) en de vijver." } },
          { name: "GSAP", desc: { en: "The guide fish that swims along as you scroll (week 4).", nl: "Het meescrollende gids-visje (week 4)." } },
          { name: "Embla Carousel", desc: { en: "The \"Visdeurbel in numbers\" fact carousel (week 3).", nl: "De \"Visdeurbel in cijfers\"-carousel (week 3)." } },
          { name: "IntersectionObserver", desc: { en: "Draw each chapter only when it scrolls into view.", nl: "Elk hoofdstuk pas tekenen bij het scrollen." } },
          { name: "Python 3", desc: { en: "Pre-aggregates the heavy event file into compact JSON.", nl: "Aggregeert het zware eventbestand vooraf tot compacte JSON." } },
          { name: "NDJSON", desc: { en: "The raw event format — one JSON object per line.", nl: "Het ruwe eventformaat — één JSON-object per regel." } },
        ],
      },
      { type: "highlights",
        heading: { en: "Engineering highlights", nl: "Technische hoogtepunten" },
        lead: { en: "The problems that taught me the most — and how I solved them.", nl: "De problemen waar ik het meest van leerde — en hoe ik ze oploste." },
        items: [
          { title: { en: "288 MB that never reaches the browser", nl: "288 MB die de browser nooit haalt" },
            problem: { en: "The raw monthly event log is <strong>288 MB</strong> of NDJSON — impossible to parse in the browser without freezing the page.", nl: "De ruwe maand-eventlog is <strong>288 MB</strong> aan NDJSON — onmogelijk in de browser te parsen zonder de pagina te bevriezen." },
            solution: { en: "A Python script reads the file <strong>line by line</strong> (never all in memory) and counts only what the charts need — per species, per hour, per country. The output is ~40 KB and loads instantly.", nl: "Een Python-script leest het bestand <strong>regel voor regel</strong> (nooit alles in het geheugen) en telt alleen wat de grafieken nodig hebben — per soort, per uur, per land. De output is ~40 KB en laadt direct." },
            code: { label: "json/build_visdata.py", lines: [
              "for line in f:                                   # line by line = low memory",
              "    d = json.loads(line)",
              "    if d.get(\"hostname\") != \"visdeurbel.nl\":     # drop noise from other hosts",
              "        continue",
              ...
              "        pond[dt.weekday()*1440 + dt.hour*60 + dt.minute] += 1   # minute-of-week",
            ] } },
          { title: { en: "A scrollytelling engine that draws once", nl: "Een scrollytelling-motor die één keer tekent" },
            problem: { en: "Drawing thirteen chapters up front would make the page heavy; redrawing them on every scroll would be wasteful.", nl: "Alle dertien hoofdstukken vooraf tekenen maakt de pagina zwaar; ze bij elke scroll opnieuw tekenen is verspilling." },
            solution: { en: "Each chapter registers a draw function under its <code>id</code>. An <code>IntersectionObserver</code> adds a <code>visible</code> class for the reveal animation and calls the draw function <strong>exactly once</strong>.", nl: "Elk hoofdstuk registreert een teken-functie onder zijn <code>id</code>. Een <code>IntersectionObserver</code> voegt een <code>visible</code>-klasse toe voor de reveal-animatie en roept de teken-functie <strong>precies één keer</strong> aan." },
            code: { label: "scripts/mitchell.js", lines: [
              "const sectionObserver = new IntersectionObserver((entries) => {",
              "  entries.forEach(entry => {",
              "    if (!entry.isIntersecting) return;",
              "    entry.target.classList.add('visible');",
              "    if (!entry.target.dataset.inited) {          // draw only once",
          ...
          { title: { en: "Switching the dataset live", nl: "De dataset live wisselen" },
            problem: { en: "A sticky pill swaps between week, month and year — but because chapters only draw once, switching left charts drawn twice with animations still running.", nl: "Een sticky pill wisselt tussen week, maand en jaar — maar omdat hoofdstukken maar één keer tekenen, bleven grafieken dubbel staan met animaties die doorliepen." },
            solution: { en: "<code>clearChapters()</code> stops every animation and empties the stages; then re-<code>observe()</code>-ing fires a fresh notification for each visible chapter, which redraws with the new data. Every chapter adapts automatically because it reads the <strong>length</strong> of the data arrays (7 / 31 / 365 days).", nl: "<code>clearChapters()</code> stopt elke animatie en leegt de stages; opnieuw <code>observe()</code>-en stuurt dan een nieuwe melding voor elk zichtbaar hoofdstuk, dat zich met de nieuwe data hertekent. Elk hoofdstuk past zich automatisch aan omdat het de <strong>lengte</strong> van de data-arrays leest (7 / 31 / 365 dagen)." },
            code: { label: "scripts/mitchell.js", lines: [
              "async function setPeriod(period) {",
              "  if (period === currentPeriod) return;",
              "  currentPeriod = period;",
              "  clearChapters();                                  // stop animations + empty stages",
              "  await loadData(period === 'week' ? '/json/vis-data-week.json' : '/json/vis-data.json');",
              "  observeChapters();                                // re-observe -> observer fires again",
              "}",
            ] },
            image: { src: "https://github.com/user-attachments/assets/1cec6464-6691-461d-8408-f5352535ec45",
              alt: { en: "The week / month / year switcher", nl: "De week- / maand- / jaar-schakelaar" },
              caption: { en: "A sticky pill swaps the dataset; every chapter redraws itself.", nl: "Een sticky pill wisselt de dataset; elk hoofdstuk hertekent zichzelf." } } },
          { title: { en: "A believable year from a month", nl: "Een geloofwaardig jaar uit één maand" },
            problem: { en: "The real yearly data is far too big for the browser, but I still wanted a Year mode.", nl: "De échte jaardata is veel te groot voor de browser, maar ik wilde toch een Jaar-modus." },
            solution: { en: "Year mode <em>synthesizes</em> a plausible year from the month snapshot: every counter ×12, 365 days of hours shaped by a <strong>seasonal wave</strong> (peaking in spring) plus noise. Honest, because it's built from the real month and clearly labelled.", nl: "De Jaar-modus <em>verzint</em> een geloofwaardig jaar uit de maand-snapshot: alle tellers ×12, 365 dagen aan uren met een <strong>seizoensgolf</strong> (piek in het voorjaar) plus ruis. Eerlijk, omdat het op de echte maand is gebaseerd en duidelijk gelabeld." },
            code: { label: "scripts/mitchell/dataLoad.js", lines: [
              "const season = 0.65 + 0.55 * Math.sin(((d - 80) / DAYS) * Math.PI * 2);",
              "const jitter = 0.82 + Math.random() * 0.36;",
              "yearHours[d * 24 + h] = Math.round(base * season * jitter);",
            ] } },
          { title: { en: "A guide fish that swims along", nl: "Een gids-visje dat meezwemt" },
            problem: { en: "A long scroll story needs something to tie the chapters together and keep it playful.", nl: "Een lang scrollverhaal heeft iets nodig dat de hoofdstukken verbindt en speels houdt." },
            solution: { en: "A small perch swims with you and circles whichever chart is nearest the centre of the screen. It's purely decorative (<code>aria-hidden</code>) and skipped entirely under <code>prefers-reduced-motion</code>. Each frame it picks a target on an ellipse around the active chart and glides there with GSAP.", nl: "Een klein baarsje zwemt met je mee en cirkelt om de grafiek die het dichtst bij het midden van het scherm staat. Het is puur decoratief (<code>aria-hidden</code>) en wordt volledig overgeslagen bij <code>prefers-reduced-motion</code>. Elke frame kiest het een doel op een ellips rond de actieve grafiek en glijdt daar met GSAP soepel naartoe." },
            code: { label: "scripts/mitchell/swimFish.js", lines: [
              ...
              "         ty:  Math.cos(angle) * radiusY };  // direction -> tilt & flip",
            ] },
            image: { src: "https://github.com/user-attachments/assets/66f79642-a6ae-4188-8140-e9426cbaa988",
              alt: { en: "The guide fish circling a chart", nl: "Het gids-visje dat om een grafiek cirkelt" },
              caption: { en: "A decorative perch follows your scroll and circles the active chart.", nl: "Een decoratief baarsje volgt je scroll en cirkelt om de actieve grafiek." } } },
        ],
      },
      { type: "timeline",
        heading: { en: "The four-week build", nl: "De bouw in vier weken" },
        items: [
          { week: { en: "Week 1 · Prototype", nl: "Week 1 · Prototype" },
            title: { en: "The first scrollytelling", nl: "De eerste scrollytelling" },
            text: { en: "I started small in bare HTML, CSS and JavaScript to answer two questions: how do I shrink the raw data enough for the browser, and how do I reveal visualizations one by one as you scroll? A Python script turned the event log into one compact <code>vis-data.json</code>, which forced the page to run on a real HTTP server (<code>fetch</code> doesn't work over <code>file://</code>). The time-based chapters I prototyped here — ring calendar, 24-hour tide, weekend vs weekday, peak-day river — laid the polar-coordinate groundwork for everything later.",
                    nl: "Ik begon klein in kale HTML, CSS en JavaScript om twee vragen te beantwoorden: hoe krijg ik de ruwe data klein genoeg voor de browser, en hoe laat ik visualisaties één voor één verschijnen bij het scrollen? Een Python-script maakte van de eventlog één compacte <code>vis-data.json</code>, wat de pagina dwong op een echte HTTP-server te draaien (<code>fetch</code> werkt niet over <code>file://</code>). De tijd-hoofdstukken die ik hier prototypeerde — ringkalender, 24-uurs getij, weekend vs doordeweeks, piekdagen-rivier — legden de polaire-coördinaten-basis voor al het latere werk." },
            images: [
              { src: "https://github.com/user-attachments/assets/ae2889c1-071c-4cc1-a0e8-7cb1cd5bbff5", alt: { en: "The entrance — particles forming a fish", nl: "De binnenkomst — deeltjes die een vis vormen" } },
              { src: "https://github.com/user-attachments/assets/e08728c1-aaa5-43ca-a668-f6915bc225fc", alt: { en: "Ring calendar (polar heatmap)", nl: "Ringkalender (polaire heatmap)" } },
              { src: "https://github.com/user-attachments/assets/0468116a-eee4-4258-bb3c-78fc67335e4d", alt: { en: "24-hour tide dial", nl: "24-uurs getij-wijzerplaat" } },
              { src: "https://github.com/user-attachments/assets/85d5f0bd-e97a-4488-b3f8-eeecba010f28", alt: { en: "Peak-day river area chart", nl: "Piekdagen-rivier (area-chart)" } },
            ] },
          { week: { en: "Week 2 · Rebuild in React", nl: "Week 2 · Herbouw in React" },
            title: { en: "A real data pipeline", nl: "Een echte datapijplijn" },
            text: { en: "With the shapes from week 1 in hand, I rebuilt everything in React + Vite, modular this time, and tackled the real 288 MB event file. A streaming Python pipeline (<code>build_visdata.py</code>) pre-aggregates both the month and week data to ~40 KB each. The story grew to thirteen chapters — a second layer about <strong>who</strong> rings, <strong>from where</strong> and <strong>with what</strong>: a world map, a rotating globe, the click-vs-ring funnel, a school of devices and a screens aquarium.",
                    nl: "Met de vormen uit week 1 op zak bouwde ik alles opnieuw op in React + Vite, dit keer modulair, en pakte ik het échte eventbestand van 288 MB aan. Een streaming Python-pijplijn (<code>build_visdata.py</code>) aggregeert zowel de maand- als weekdata vooraf tot elk ~40 KB. Het verhaal groeide naar dertien hoofdstukken — een tweede laag over <strong>wie</strong> er belt, <strong>waarvandaan</strong> en <strong>waarmee</strong>: een wereldkaart, een draaiende globe, de wegklik-vs-bel-funnel, een school apparaten en een schermen-aquarium." },
            images: [
              { src: "https://github.com/user-attachments/assets/95ee2232-2f4a-4cdc-825f-2c39b46eaa92", alt: { en: "World map with arcs flowing to Utrecht", nl: "Wereldkaart met bogen naar Utrecht" } },
              { src: "https://github.com/user-attachments/assets/fb67bb10-a031-497d-9364-8ae0d3d454db", alt: { en: "Rotating orthographic globe", nl: "Draaiende orthografische globe" } },
              { src: "https://github.com/user-attachments/assets/34d78c31-ec76-48be-95f1-02d3918a7435", alt: { en: "Ring-vs-dismiss funnel", nl: "Bel-vs-wegklik-funnel" } },
              { src: "https://github.com/user-attachments/assets/2314ee51-6d74-4e28-8a35-d2169936bd4a", alt: { en: "A school of devices by browser", nl: "Een school apparaten per browser" } },
            ] },
          { week: { en: "Week 3 · Polish & accessibility", nl: "Week 3 · Afwerking & toegankelijkheid" },
            title: { en: "One coherent, accessible whole", nl: "Eén samenhangend, toegankelijk geheel" },
            text: { en: "Design tokens fixed colors, fonts and spacing; wave transitions connect the sections like on visdeurbel.nl. Each fish species got a real photo, tinted <strong>luminance-preserving</strong> (grayscale × species color) so it keeps its texture. An accessibility menu added \"reduce motion\" and \"high contrast\" (saved to <code>localStorage</code>), and a \"Visdeurbel in numbers\" Embla carousel turns the data into fact cards.",
                    nl: "Design tokens legden kleuren, lettertypes en spacing vast; golf-overgangen verbinden de secties net als op visdeurbel.nl. Elke vissoort kreeg een echte foto, <strong>luminantie-behoudend</strong> ingekleurd (grijswaarde × soortkleur) zodat de textuur behouden blijft. Een toegankelijkheidsmenu voegde \"animaties uit\" en \"hoger contrast\" toe (opgeslagen in <code>localStorage</code>), en een \"Visdeurbel in cijfers\"-Embla-carousel zet de data om in feiten-kaartjes." },
            images: [
              { src: "https://github.com/user-attachments/assets/8c229990-8dca-4810-ac48-976e9d072394", alt: { en: "\"Visdeurbel in numbers\" fact carousel", nl: "\"Visdeurbel in cijfers\"-carousel" } },
              { src: "https://github.com/user-attachments/assets/865790d7-e759-4073-9c95-5cd65a7010a8", alt: { en: "The canvas aquarium", nl: "Het canvas-aquarium" } },
            ] },
          { week: { en: "Week 4 · Refactor & depth", nl: "Week 4 · Refactor & verdieping" },
            title: { en: "Structure, a Year mode and a guide fish", nl: "Structuur, een Jaar-modus en een gids-visje" },
            text: { en: "The final week was about structure, not more chapters. Every component now exports its own <code>init</code> function beside its JSX, so markup and drawing logic live together; <code>mitchell.js</code> became a thin orchestrator and retired code was <strong>archived</strong> in <code>legacy/</code> rather than deleted. I added the synthesized Year mode, a radar with a time-scrubber, real fish photos inside the net's bubbles, the chorus of languages, and the guide fish that swims along.",
                    nl: "De laatste week ging over structuur, niet meer hoofdstukken. Elke component exporteert nu zijn eigen <code>init</code>-functie naast zijn JSX, zodat markup en tekenlogica bij elkaar zitten; <code>mitchell.js</code> werd een dunne orchestrator en oude code werd <strong>gearchiveerd</strong> in <code>legacy/</code> in plaats van verwijderd. Ik voegde de verzonnen Jaar-modus toe, een radar met tijd-slider, echte vis-foto's in de bellen van het net, het koor van talen, en het meescrollende gids-visje." },
            images: [
              { src: "https://github.com/user-attachments/assets/7bdb5d43-c780-464f-9098-9a041a021f56", alt: { en: "Radar with a time-scrubber", nl: "Radar met tijd-slider" } },
              { src: "https://github.com/user-attachments/assets/b3316758-322a-439c-b580-cabd195e815b", alt: { en: "The net — fish photos inside bubbles", nl: "Het net — vis-foto's in de bellen" } },
              { src: "https://github.com/user-attachments/assets/81720e35-981b-437d-b741-eb90509afd43", alt: { en: "Chorus of languages — \"fish\" in many tongues", nl: "Koor van talen — \"vis\" in vele talen" } },
            ] },
        ],
      },
      { type: "prose",
        heading: { en: "What I learned", nl: "Wat ik leerde" },
        lead: { en: "From a rough prototype to a polished, accessible scrollytelling, the thread stayed the same: let the data drive the work, and clean up the code slowly.",
                nl: "Van ruw prototype naar verzorgde, toegankelijke scrollytelling bleef de rode draad dezelfde: laat de data het werk sturen, en ruim de code langzaam op." },
        paragraphs: [
          { en: "<strong>Separate data processing from visualization.</strong> Heavy aggregation belongs in a Python step, not the browser; the charts only need the numbers. Reading array lengths everywhere meant the same code works for week, month and year data. And anything I start — animation frames, observers, simulations — I have to be able to stop again, especially under React StrictMode, which mounts everything twice.",
            nl: "<strong>Scheid dataverwerking van visualisatie.</strong> Zwaar aggregeren hoort in een Python-stap, niet in de browser; de grafieken hebben alleen de getallen nodig. Overal arraylengtes lezen betekende dat dezelfde code werkt voor week-, maand- én jaardata. En alles wat ik start — animatieframes, observers, simulaties — moet ik ook weer kunnen stoppen, zeker onder React StrictMode, dat alles dubbel mount." },
          { en: "The biggest leap wasn't a new chapter but understanding everyone's code and the <strong>structure</strong>: giving each chapter its own chart and archiving old code kept the project maintainable and left room for the fun details, like the fish that swims with you. Using AI to iterate quickly was smart, but next time I'll document what changed as I go — I tracked it too late and lost time getting back up to speed.",
            nl: "De grootste sprong zat niet in een nieuw hoofdstuk, maar in het begrijpen van ieders code en de <strong>structuur</strong>: elk hoofdstuk zijn eigen grafiek geven en oude code archiveren hield het project onderhoudbaar en liet ruimte voor de leuke details, zoals het visje dat met je meezwemt. AI gebruiken om snel te itereren was slim, maar volgende keer documenteer ik onderweg wat er verandert — ik hield het te laat bij en verloor tijd om weer bij te komen." },
          { en: "Against my learning goals I'm happy with the progress. <strong>Collaboration</strong> grew a lot — from online communication to daily stand-ups, and from Git merge conflicts to pull requests. <strong>UX</strong> improved through feedback sessions with the client, so testers and the client now understand what's expected of them. And <strong>data visualization</strong> was completely new to me; after a lot of D3 tutorials and examples it finally clicked. One honest critique: despite the SPA, the four team sections still read as visibly different designs — the wave transitions help, but the styles don't fully merge.",
            nl: "Tegen mijn leerdoelen ben ik tevreden over de vooruitgang. <strong>Samenwerking</strong> is sterk verbeterd — van online communicatie tot dagelijkse stand-ups, en van Git-merge-conflicten tot pull requests. <strong>UX</strong> verbeterde door feedbacksessies met de opdrachtgever, zodat testpersonen en de opdrachtgever nu begrijpen wat er van ze verwacht wordt. En <strong>datavisualisatie</strong> was helemaal nieuw voor me; na veel D3-tutorials en voorbeelden viel het kwartje. Eén eerlijk kritiekpunt: ondanks de SPA lezen de vier teamsecties nog als duidelijk verschillende ontwerpen — de golf-overgangen helpen, maar de stijlen versmelten nog niet helemaal." },
        ],
      },
      { type: "cta",
        heading: { en: "Want to see it move?", nl: "Benieuwd hoe het beweegt?" },
        text: { en: "The full scrollytelling is live on Render — scroll through all thirteen chapters.", nl: "De volledige scrollytelling draait live op Render — scroll door alle dertien hoofdstukken." } },
    ],
  },
};
